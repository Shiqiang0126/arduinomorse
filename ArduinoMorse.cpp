...
#define T 75
#define DOT (T)         // Duration of a dot
#define DASH (3*T)         // Duration of a dash
#define INNER_PAUSE (T)  // Duration of pause between dot and dash in a character 
#define CHAR_BREAK (3*T)    // Duration of pause between characters
#define WORD_BREAK (7*T)   //Duration of pause between words (spaces, punctuation, etc)
